...
2. We let the standard error of the ABETA measurements be different for each individual, and place a hierarchical prior over these parameters. The biomarker plots sugggest that the random variation in these measurements may different in magnitude from person to person. 
